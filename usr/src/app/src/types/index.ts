...
import type { AuthContextType as OriginalAuthContextType, AuthUser as OriginalAuthUser } from '@/components/auth/auth-provider';


export interface AuthUser extends OriginalAuthUser {}

export interface AuthContextType extends Omit<OriginalAuthContextType, 'login'> {
