...
const AuthProvider = ({ children })=>{
    ...
    const verifySession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[verifySession]": async ()=>{
            try {
                ...
                if (res.ok) {
                    ...
                    setUser(null);
                    if (PROTECTED_ROUTES.some({
                        "AuthProvider.useCallback[verifySession]": (p)=>pathname.startsWith(p)
                    }["AuthProvider.useCallback[verifySession]"])) {
...
_s(AuthProvider, "zaVZ4qaRtIDgQwRTdPTKHQ3Y3qU=", false, function() {
    return [
...
//# sourceMappingURL=src_3a4542cf._.js.map