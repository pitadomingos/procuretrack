...
"[project]/.next-internal/server/app/api/purchase-orders/get-by-po-number/[poNumber]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/purchase-orders/get-by-po-number/[poNumber]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].execute('SELECT id FROM PurchaseOrder WHERE poNumber = ?', [
            decodedPoNumber
        ]);
        if (Array.isArray(rows) && rows.length > 0) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Purchase Order with PO Number ${decodedPoNumber} not found`
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82c88d81._.js.map