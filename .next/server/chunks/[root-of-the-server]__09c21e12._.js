...
"[project]/.next-internal/server/app/api/purchase-orders/for-grn/[poNumber]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/purchase-orders/for-grn/[poNumber]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const [poHeaderRows] = await connection.execute('SELECT * FROM PurchaseOrder WHERE poNumber = ?', [
            decodedPoNumber
        ]);
        if (poHeaderRows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Purchase Order with PO Number ${decodedPoNumber} not found.`
            }, {
                status: 404
            });
        }
        ...
        if (poHeader.status !== 'Approved') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Purchase Order ${decodedPoNumber} is not approved. Current status: ${poHeader.status}. Cannot receive items.`
            }, {
                status: 400
            });
        }
        if (poHeader.supplierId) {
            const [supplierRows] = await connection.execute('SELECT * FROM Supplier WHERE supplierCode = ?', [
                poHeader.supplierId
            ]);
            if (supplierRows.length > 0) {
                poHeader.supplierDetails = supplierRows[0];
            }
        }
      ...
      WHERE poi.poId = ?
    `;
        const [poItemRows] = await connection.execute(poItemsQuery, [
            poHeader.id
        ]);
        const poItems = poItemRows.map((item)=>({
                id: item.id,
                poId: item.poId,
        ...
        if (poItems.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `No items found for approved Purchase Order ${decodedPoNumber}.`
            }, {
                status: 404
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Failed to fetch purchase order data for GRN.',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__09c21e12._.js.map