...
"[project]/src/app/api/suppliers/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/stream [external] (stream, cjs)"); // Import Readable stream
;
;
;
;
...
async function GET() {
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].execute('SELECT * FROM Supplier');
...
const upload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$multer$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
    storage: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$multer$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].memoryStorage()
});
...
async function POST(request) {
    const res = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](); // Create a NextResponse instance for multer
    try {
        ...
        const stream = __TURBOPACK__imported__module__$5b$externals$5d2f$stream__$5b$external$5d$__$28$stream$2c$__cjs$29$__["Readable"].from(file.buffer);
        await new Promise((resolve, reject)=>{
            stream.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$csv$2d$parser$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])()).on('data', (data)=>results.push(data)).on('end', ()=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Supplier file uploaded and parsed successfully',
            data: results
        });
    } catch (error) {
        console.error('Error uploading or parsing supplier CSV:', error);
        // Check if the error is from multer (e.g., file size limit)
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$multer$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].MulterError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // General error
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to upload or process supplier file'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c92e481._.js.map