...
"[project]/.next-internal/server/app/api/charts/fuel-cost-by-tag/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/charts/fuel-cost-by-tag/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const queryParams = [];
        if (month && month !== 'all') {
            whereClauses.push("MONTH(fr.fuelDate) = ?");
            queryParams.push(parseInt(month, 10));
        }
        if (year && year !== 'all') {
            whereClauses.push("YEAR(fr.fuelDate) = ?");
            queryParams.push(parseInt(year, 10));
        }
        if (siteId && siteId !== 'all') {
            whereClauses.push("fr.siteId = ?");
    ...
    `;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch fuel cost by tag data',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a757af9._.js.map