...
"[project]/.next-internal/server/app/api/purchase-orders/[poId]/reject/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/purchase-orders/[poId]/reject/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const [poRows] = await connection.execute('SELECT status FROM PurchaseOrder WHERE id = ? FOR UPDATE', [
            numericPoId
        ]);
        if (poRows.length === 0) {
        ...
        if (currentStatus !== 'Pending Approval') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Purchase Order cannot be rejected. Current status: ${currentStatus}`
            }, {
                status: 400
            });
        }
        ...
        await connection.execute('UPDATE PurchaseOrder SET status = ?, approvalDate = NULL WHERE id = ?', // If you add rejectionReason and rejectionDate columns to your DB:
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ea70f8b._.js.map