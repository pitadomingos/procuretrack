...
"[project]/.next-internal/server/app/api/requisitions/[id]/approve/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/requisitions/[id]/approve/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const [reqRows] = await connection.execute('SELECT status, approverId FROM Requisition WHERE id = ? FOR UPDATE', [
            requisitionId
        ]);
        if (reqRows.length === 0) {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Requisition with ID ${requisitionId} not found`
            }, {
                status: 404
            });
        }
        ...
        if (requisition.status !== 'Pending Approval') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Requisition is not pending approval. Current status: ${requisition.status}`
            }, {
                status: 400
            });
        }
        ...
        await connection.execute('UPDATE Requisition SET status = ?, approvalDate = ?, updatedAt = NOW() WHERE id = ?', [
            'Approved',
            approvalDate,
            requisitionId
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Failed to approve requisition ${requisitionId}.`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5947af2._.js.map