...
"[project]/.next-internal/server/app/api/requisitions/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/requisitions/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
      ...
      WHERE r.id = ?
    `;
        const [reqRows] = await connection.execute(requisitionQuery, [
            id
        ]);
        if (reqRows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Requisition with ID ${id} not found.`
            }, {
                status: 404
            });
        }
        const requisitionData = {
            ...reqRows[0],
            siteId: Number(reqRows[0].siteId),
    ...
    `;
        const [itemRows] = await connection.execute(itemsQuery, [
            id
        ]);
        // Map to RequisitionItem type, which now has justification instead of notes, and no siteId
        requisitionData.items = itemRows.map((item)=>({
                id: item.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(requisitionData);
    } catch (error) {
        console.error(`[API_ERROR] /api/requisitions/${id} GET:`, error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Failed to fetch requisition ${id}.`,
...
async function PUT(request, { params }) {
    ...
    if (!id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Requisition ID is required for update'
        }, {
            status: 400
        });
    }
    ...
    try {
        ...
        const [currentReq] = await connection.execute('SELECT status FROM Requisition WHERE id = ?', [
            id
        ]);
        if (currentReq.length === 0) {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Requisition not found for update.'
            }, {
                status: 404
            });
        }
        if (currentReq[0].status !== 'Draft' && currentReq[0].status !== 'Pending Approval') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Cannot update requisition. Status is '${currentReq[0].status}'. Only 'Draft' or 'Pending Approval' requisitions can be edited.`
            }, {
                status: 400
            });
        }
        ...
        await connection.execute(`UPDATE Requisition SET 
       ...
       WHERE id = ?`, [
        ...
        await connection.execute('DELETE FROM RequisitionItem WHERE requisitionId = ?', [
            id
        ]);
      ...
      WHERE r.id = ?
    `;
        const [updatedReqRows] = await connection.execute(getUpdatedQuery, [
            id
        ]);
      ...
      WHERE ri.requisitionId = ?
    `;
        const [updatedItemRows] = await connection.execute(itemsQueryUpdated, [
            id
        ]);
        updatedRequisition.items = updatedItemRows.map((item)=>({
                id: item.id,
                requisitionId: item.requisitionId,
                partNumber: item.partNumber,
                description: item.description,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedRequisition);
    } catch (error) {
        if (connection) await connection.rollback();
        console.error(`[API_ERROR] /api/requisitions/${id} PUT:`, error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Failed to update requisition ${id}.`,
            details: error.message
        }, {
            status: 500
        });
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        if (currentReq.length === 0) {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Requisition not found for deletion.'
            }, {
                status: 404
            });
        }
        if (currentReq[0].status !== 'Draft' && currentReq[0].status !== 'Rejected') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Cannot delete requisition. Status is '${currentReq[0].status}'. Only 'Draft' or 'Rejected' requisitions can be deleted directly.`
            }, {
                status: 400
            });
        }
        ...
        const [result] = await connection.execute('DELETE FROM Requisition WHERE id = ?', [
            id
        ]);
        if (result.affectedRows === 0) {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Requisition not found or already deleted'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__919c0585._.js.map