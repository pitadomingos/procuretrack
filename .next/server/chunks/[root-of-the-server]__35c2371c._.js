...
async function POST(request) {
    ...
    try {
        ...
        const [result] = await connection.execute('INSERT INTO Site (name, location, siteCode) VALUES (?, ?, ?)', [
            name,
            location || null,
            siteCode || null
        ]);
        ...
        const [newSiteRows] = await connection.execute('SELECT * FROM Site WHERE id = ?', [
            insertId
        ]);
