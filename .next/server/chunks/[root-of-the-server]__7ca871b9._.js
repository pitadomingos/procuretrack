...
"[project]/.next-internal/server/app/api/purchase-orders/pending-approval/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/purchase-orders/pending-approval/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const [approverRows] = await connection.execute('SELECT id FROM Approver WHERE email = ? AND isActive = TRUE', [
            approverEmail
        ]);
        if (approverRows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `No active approver found with email ${approverEmail}`
            }, {
                status: 404
            });
        }
    ...
    `;
        const [poRows] = await connection.execute(query, [
            approverId
        ]);
        const results = poRows.map((row)=>({
                id: row.id,
                ...
                creatorName: row.creatorName || (row.creatorUserId ? 'Unknown User' : 'System'),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ca871b9._.js.map