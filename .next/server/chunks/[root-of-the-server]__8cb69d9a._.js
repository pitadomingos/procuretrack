...
"[project]/.next-internal/server/app/api/purchase-orders/[poId]/approve/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/purchase-orders/[poId]/approve/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/db.js [app-route] (ecmascript)"); // Adjusted path
;
;
async function POST(request, { params }) {
    ...
    try {
        ...
        const [poRows] = await connection.execute('SELECT * FROM PurchaseOrder WHERE id = ? FOR UPDATE', [
            numericPoId
        ]);
        if (poRows.length === 0) {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Purchase Order with ID ${numericPoId} not found`
            }, {
                status: 404
            });
        }
        ...
        if (purchaseOrder.status !== 'Pending Approval') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Purchase Order is not pending approval. Current status: ${purchaseOrder.status}`
            }, {
                status: 400
            });
        }
        ...
        if (!assignedApproverId) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No approver assigned to this Purchase Order. Cannot approve.'
            }, {
                status: 400
            });
        }
        ...
        await connection.execute('UPDATE PurchaseOrder SET status = ?, approvalDate = ? WHERE id = ?', [
            'Approved',
            approvalDate,
            numericPoId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8cb69d9a._.js.map