...
"[project]/.next-internal/server/app/api/charts/po-cycle-time/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/charts/po-cycle-time/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `;
        ...
        chartData.sort((a, b)=>{
            return BUCKET_ORDER.indexOf(a.name) - BUCKET_ORDER.indexOf(b.name);
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(finalChartData);
    } catch (error) {
        console.error('Error fetching PO cycle time data:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch PO cycle time data',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41e80848._.js.map