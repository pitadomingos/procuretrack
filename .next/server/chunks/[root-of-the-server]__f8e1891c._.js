...
async function GET(request, { params }) {
    const { poId } = params;
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].execute('SELECT * FROM POItem WHERE poId = ?', [
            poId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8e1891c._.js.map