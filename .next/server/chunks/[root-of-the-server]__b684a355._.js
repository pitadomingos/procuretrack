...
async function POST(request) {
    ...
    if (contentType && contentType.includes('multipart/form-data')) {
      ...
      `;
            ...
            const [newClientRows] = await pool.execute('SELECT id, name, address, city, country, contactPerson, email, createdAt, updatedAt FROM Client WHERE id = ?', [
                clientData.id
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b684a355._.js.map