...
"[project]/.next-internal/server/app/api/quotes/[id]/approve/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/quotes/[id]/approve/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const [quoteRows] = await connection.execute('SELECT status FROM Quote WHERE id = ? FOR UPDATE', [
            quoteId
        ]);
        ...
        if (quoteRows[0].status !== 'Pending Approval') {
            await connection.rollback();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Quote is not pending approval. Current status: ${quoteRows[0].status}`
            }, {
                status: 400
            });
        }
        const approvalDate = new Date();
        await connection.execute('UPDATE Quote SET status = ?, approvalDate = ?, updatedAt = NOW() WHERE id = ?', [
            'Approved',
            approvalDate,
            quoteId
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Failed to approve quote ${quoteId}.`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b111b0fd._.js.map