...
"[project]/.next-internal/server/app/api/quotes/get-by-quote-number/[quoteNumber]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/quotes/get-by-quote-number/[quoteNumber]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const [rows] = await connection.execute('SELECT id FROM Quote WHERE quoteNumber = ?', [
            decodedQuoteNumber
        ]);
        if (rows.length > 0) {
            const quoteData = rows[0]; // Quote ID is string
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                id: quoteData.id
            });
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Quote with number ${decodedQuoteNumber} not found`
            }, {
                status: 404
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch quote details by number.',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b37979c._.js.map