...
"[project]/.next-internal/server/app/api/charts/maverick-spend/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/charts/maverick-spend/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        let whereClauses = [
            "notes LIKE '%emergency%'"
        ]; // Case-insensitive might depend on DB collation, otherwise use LOWER(notes)
        const queryParams = [];
        if (month && month !== 'all') {
    ...
    `;
        ...
        const chartData = [
            {
                name: "Emergency POs Value (MZN)",
                value: emergencyValue
            },
            {
                name: "Emergency POs Count",
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch maverick spend data',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e5ad830d._.js.map