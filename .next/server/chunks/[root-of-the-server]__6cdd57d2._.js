...
"[project]/.next-internal/server/app/api/requisitions/pending-approval/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/requisitions/pending-approval/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `;
        const [reqRows] = await connection.execute(query, [
            approverId
        ]);
        const results = reqRows.map((row)=>({
                id: row.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch pending requisition approvals.',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6cdd57d2._.js.map