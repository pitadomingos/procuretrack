...
export function MonthlyStatusChart({ filters }: MonthlyStatusChartProps) {
  ...
  return (
    <Card className="shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-in-out">
      <CardHeader>
        ...
        <CardDescription>Approved and Pending Approval POs by month.</CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data}>
              ...
              <Bar dataKey="Approved" stackId="a" fill="hsl(var(--chart-1))" radius={[4, 4, 0, 0]} />
              <Bar dataKey="Pending Approval" stackId="a" fill="hsl(var(--chart-3))" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        )}
      </CardContent>
